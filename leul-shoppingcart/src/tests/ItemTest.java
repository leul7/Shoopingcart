...
/**
 * A test case for the item class.
 * 
 * @author Leul Amare
 * @version 01/24/2018
 *
...
public class ItemTest {
    ...
    public void testConstructorBulkNullPrice() {
        new Item("NP", null, 4, new BigDecimal("30"));
    }
    ...
    public void testConstructorBulkLessZeroPrice() {
        new Item("ZP", new BigDecimal("-1"), 4, new BigDecimal("30"));
    }
    ...
    public void testConstructorBulkLessZeroBulkQuantity() {
        new Item("ZPQ", BigDecimal.TEN, -1, new BigDecimal("30"));
    }
    ...
    public void testConstructorBulkNullBulkPrice() {
        new Item("ZBP", BigDecimal.TEN, 4, null);
    }
    ...
    public void testConstructorBulkLessZeroBulkPrice() {
        new Item("ZBP", BigDecimal.TEN, 4, new BigDecimal("-1"));
    }
    ...
    public void testToStringBulk() {
        assertEquals("testBulk , $10.00 (4for$30.00)", myItemBulk.toString());
